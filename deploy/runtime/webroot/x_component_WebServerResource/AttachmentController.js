...
MWF.xApplication.WebServerResource.AttachmentController = new Class({
    ...
    addAttachment: function(data){
        if (this.options.size=="min"){
            ...
            this.attachments.push(new MWF.xApplication.WebServerResource.AttachmentController.Attachment(data, this));
        }
    },
    addAttachmentFolder: function(data){
        var folder = new MWF.xApplication.WebServerResource.AttachmentController.Folder(data, this);
...
MWF.xApplication.WebServerResource.AttachmentController.Attachment = new Class({
    ...
    loadList: function(){
        ...
        this.textTitleNode.set("text", this.data.fileName);
    ...
    createInforNode: function(callback){
        ...
        var html = "<div style='overflow:hidden; font-weight: bold'>"+this.data.fileName+"</div>";
        ...
        if (shareList || sendList){
            var flagNode = new Element("div", {
                "styles": {
                    "width": "24px",
                    "height": "24px",
                    "background": "url("+"../x_component_WebServerResource/$Main/default/icon/share_flag_preview.png) center center no-repeat",
                    "position": "relative",
                    "top": "-28px"
                }
        ...
        if (shareList || sendList){
            var flagNode = new Element("div", {
                "styles": {
                    "width": "16px",
                    "height": "16px",
                    "background": "url("+"../x_component_WebServerResource/$Main/default/icon/share_flag_icon.png) center center no-repeat",
                    "position": "relative",
                    "top": "-18px"
                }
            }).inject(this.iconImgAreaNode);
        ...
        if (shareList || sendList){
            var flagNode = new Element("div", {
                "styles": {
                    "width": "10px",
                    "height": "10px",
                    "background": "url("+"../x_component_WebServerResource/$Main/default/icon/share_flag_list.png) center center no-repeat",
                    "position": "relative",
                    "top": "-14px"
                }
            }).inject(this.iconImgAreaNode);
...
MWF.xApplication.WebServerResource.AttachmentController.Folder = new Class({
    Extends: MWF.widget.AttachmentController.Attachment,
    ...
    loadPreview: function(){
        ...
        this.textNode.set("text", this.data.fileName);
    },
    setEvent: function(){
        this.node.addEvents({
