...
MWF.xApplication.StandingBook.Input = new Class({
    ...
    _createVueData: function(){
        this.json = {
            ...
            focus: function () {
                this.fireEvent("focus", [this.json.data]);
            }.bind(this),
            blur: function () {
            ...
            enter: function(){
                this.fireEvent("enter", [this.json.data]);
            }.bind(this),
            clear: function () {
                // debugger;
                this.fireEvent("clear", [this.json.data]);
            }.bind(this)
        };
...
MWF.xApplication.StandingBook.NumberRange = new Class({
    ...
    _createVueData: function(){
        ...
        this.json = {
            ...
            min: {
                ...
                enter: function(){
                    if( this.checkMin() ) {
                        this.change(function (min, max) {
                            this.fireEvent("enter", [[min, max]]);
                        }.bind(this))
                    }
                }.bind(this),
                focus: function () {},
    ...
    _createElementHtml: function() {
        ...
        html += " @keyup.enter.native=\"max.enter\"";
