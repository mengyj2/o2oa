...
MWF.xApplication.TeamWork.Tasks = new Class({
    Extends: MPopupForm,
    ...
    initialize: function (explorer, data, options, para) {
        ...
        this.css = {};
        this.cssPath = "../x_component_TeamWork/$Tasks/"+this.options.style+"/css.wcss";
    ...
    _createTableContent: function () {
        ...
        this.getTaskData(function(){
            ...
            this.topIconClose.addEvents({
                ...
                mouseover:function(){
                    this.setStyles({"background-image":"url(../x_component_TeamWork/$Tasks/default/icon/icon_off_click.png)"});
                },
                mouseout:function(){
    ...
    createContentLayout:function(){
        ...
        if(this.taskData.parent!="0"){
            ...
            this.taskActionParentValue.set("text",this.taskData.parentName);
            
            this.actions.canRead(this.taskData.parent,function(json){
                if(json.data.value){
                    this.taskActionParentValue.addEvents({
                        click:function(){
                            this.data.taskId = this.taskData.parent
                            this.openTask()
                        }.bind(this)
                    });
                }else{
                    this.taskActionParentValue.setStyles({"color":"#666666","cursor":""})
                }
            }.bind(this))
        ...
        //所属项目
        this.taskProjectContainer = new Element('div.taskProjectContainer',{styles:this.css.taskProjectContainer}).inject(this.taskInforContent);
        this.taskProjectIcon = Element("div.taskProjectIcon",{styles:this.css.taskProjectIcon}).inject(this.taskProjectContainer);
        this.taskProjectText = Element("div.taskProjectText",{styles:this.css.taskProjectText,text:this.lp.taskProject}).inject(this.taskProjectContainer);
        this.taskProjectValue = Element("div.taskProjectValue",{styles:this.css.taskProjectValue,'text':this.projectData?this.projectData.title||"" : ""}).inject(this.taskProjectContainer);
        ...
        //来源
        this.taskSourceContainer = Element("div.taskSourceContainer",{styles:this.css.taskSourceContainer}).inject(this.taskInforContent);
        Element("div.taskSourceIcon",{styles:this.css.taskSourceIcon}).inject(this.taskSourceContainer);
        Element("div.taskSourceText",{styles:this.css.taskSourceText,text:this.lp.taskSource}).inject(this.taskSourceContainer);
        this.taskSourceValue = Element("div.taskSourceValue",{styles:this.css.taskSourceValue}).inject(this.taskSourceContainer);
        ...
        //任务进展
        this.taskDetailContainer = Element("div.taskDetailContainer",{styles:this.css.taskDetailContainer}).inject(this.taskInforContent);
        Element("div.taskDetailIcon",{styles:this.css.taskDetailIcon}).inject(this.taskDetailContainer);
        Element("div.taskDetailText",{styles:this.css.taskDetailText,text:this.lp.taskDetail}).inject(this.taskDetailContainer);
        this.taskDetailValue = Element("div.taskDetailValue",{styles:this.css.taskDetailValue}).inject(this.taskDetailContainer);

        //重要程度
        this.taskImportantContainer = Element("div.taskImportantContainer",{styles:this.css.taskImportantContainer}).inject(this.taskInforContent);
        Element("div.taskImportantIcon",{styles:this.css.taskImportantIcon}).inject(this.taskImportantContainer);
        Element("div.taskImportantText",{styles:this.css.taskImportantText,text:this.lp.important}).inject(this.taskImportantContainer);
        this.taskImportantValue = Element("div.taskImportantValue",{styles:this.css.taskImportantValue}).inject(this.taskImportantContainer);

        //紧急程度
        this.taskUrgencyContainer = Element("div.taskUrgencyContainer",{styles:this.css.taskUrgencyContainer}).inject(this.taskInforContent);
        Element("div.taskUrgencyIcon",{styles:this.css.taskUrgencyIcon}).inject(this.taskUrgencyContainer);
        Element("div.taskUrgencyText",{styles:this.css.taskUrgencyText,text:this.lp.urgency}).inject(this.taskUrgencyContainer);
        this.taskUrgencyValue = Element("div.taskUrgencyValue",{styles:this.css.taskUrgencyValue}).inject(this.taskUrgencyContainer);    

        //工作进度
        this.taskProgressContainer = Element("div.taskProgressContainer",{styles:this.css.taskProgressContainer}).inject(this.taskInforContent);
        Element("div.taskProgressIcon",{styles:this.css.taskProgressIcon}).inject(this.taskProgressContainer);
        Element("div.taskProgressText",{styles:this.css.taskProgressText,text:this.lp.progress}).inject(this.taskProgressContainer);
        this.taskProgressValue = Element("div.taskProgressValue",{styles:this.css.taskProgressValue}).inject(this.taskProgressContainer);   
    ...
    createParticipateContainer:function(){
        ...
        if(this.control.isEdit && (this.taskData.workStatus != "completed" && this.taskData.workStatus != "canceled") ){
            ...
            this.participateTitleIcon.addEvents({ 
                click:function(){
                    this.selectPerson(this.participateTitleIcon,null,["identity"],0,
                        function(json){
                            if(json.length>0){
    ...
    createDynamicContainer:function(){
        ...
        this.dynamicBar.addEvents({
            mouseover:function(){
                ...
                this.dynamicIcon.setStyle("background-image","url(../x_component_TeamWork/$Tasks/default/icon/icon_dw_click.png)")
            }.bind(this),
            mouseout:function(){
                this.dynamicText.setStyle("color","#666666");
                this.dynamicIcon.setStyle("background-image","url(../x_component_TeamWork/$Tasks/default/icon/icon_dw.png)")
            }.bind(this),
            click:function(){
                var pc = new MWF.xApplication.TeamWork.Tasks.DynamicType(this.container, this.dynamicBar, this.app, {data:this.taskData}, {
                    ...
                    onClose:function(rd){
                        if(!rd) return;
                        //var filter = {"orderType":"","orderField":""};
                        var filter = {};
                        if(rd.value == "all"){
        ...
        this.dynamicContent.addEvents({
            scroll:function(){
                if(this.getScrollTop()==0){  
                    ...
                    _self.createDynamicContent(_self.curDynamicPage,filter,function(){
    ...
    createDynamicContent:function(page,data,callback){
        this.getDynamicStatus = true;
        var _self = this;
        //var id = id || "(0)"; 
        this.curDynamicPage = page || 1;
        var count = 30; 
        ...
        this.rootActions.DynamicAction.listNextWithTask(this.curDynamicPage,count,taskId,data||{},function(json){
    ...
    loadDynamicItem:function(data,where){
        ...
        if(objectType == "CHAT"){
            ...
            dynamicItemIcon.setStyle("background-image","url(../x_component_TeamWork/$Tasks/default/icon/dy_chat.png)")
            //}
        }else if(objectType == "ATTACHMENT"){
            if(optType == "DELETE"){  //UPLOAD、DOWNLOAD、DELETE
                dynamicItemIcon.setStyle("background-image","url(../x_component_TeamWork/$Tasks/default/icon/dy_remove.png)")
            }else{
                dynamicItemIcon.setStyle("background-image","url(../x_component_TeamWork/$Tasks/default/icon/dy_attachment.png)")
            }
            ...
            if(optType=="SPLIT"){
                dynamicItemIcon.setStyle("background-image","url(../x_component_TeamWork/$Tasks/default/icon/dy_subtask.png)")
            }else if(optType=="DELETE_SUBTASK"){
                dynamicItemIcon.setStyle("background-image","url(../x_component_TeamWork/$Tasks/default/icon/dy_remove.png)")
            }else if(optType=="UPDATE_EXECUTOR"){
                dynamicItemIcon.setStyle("background-image","url(../x_component_TeamWork/$Tasks/default/icon/dy_duty.png)")
            }else if(optType=="UPDATE_NAME"){
                dynamicItemIcon.setStyle("background-image","url(../x_component_TeamWork/$Tasks/default/icon/dy_title.png)")
            }else if(optType=="UPDATE_WORKSTATUS"){
                dynamicItemIcon.setStyle("background-image","url(../x_component_TeamWork/$Tasks/default/icon/dy_status.png)")
            }else if(optType=="UPDATE_WORKDATE"){
                dynamicItemIcon.setStyle("background-image","url(../x_component_TeamWork/$Tasks/default/icon/dy_time.png)")
            }else if(optType=="UPDATE_DESCRIPTION"){
                dynamicItemIcon.setStyle("background-image","url(../x_component_TeamWork/$Tasks/default/icon/dy_remark.png)")
            }else if(optType=="ADD_PARTICIPANTS" || optType == "REMOVE_PARTICIPANTS"){
                dynamicItemIcon.setStyle("background-image","url(../x_component_TeamWork/$Tasks/default/icon/dy_participant.png)")
            }else if(optType=="CREATE"){
                dynamicItemIcon.setStyle("background-image","url(../x_component_TeamWork/$Tasks/default/icon/icon_jia.png)")
            }else{
                dynamicItemIcon.setStyle("background-image","url(../x_component_TeamWork/$Tasks/default/icon/icon_edit.png)")
            }
            ...
            if(optType=="REMOVE"){
                ...
                dynamicItemIcon.setStyle("background-image","url(../x_component_TeamWork/$Tasks/default/icon/dy_tag.png)")
            }
        }
    ...
    createChatContainer:function(){
        ...
        this.chatBarEmoji.addEvents({
            mouseover:function(){this.setStyle("background-image","url(../x_component_TeamWork/$Tasks/default/icon/icon_emoji_click.png)")},
            mouseout:function(){this.setStyle("background-image","url(../x_component_TeamWork/$Tasks/default/icon/icon_emoji.png)")},
            click:function(){
                    ...
                    this.rootActions.ChatAction.create(data,function(json){
                        if(json.data.id){
                            this.rootActions.ChatAction.get(json.data.id,function(json){
                                ...
                                var dynamicItemIcon = new Element("div.dynamicItemIcon",{styles:this.css.dynamicItemIcon}).inject(dynamicItem);
                                dynamicItemIcon.setStyle("background-image","url(../x_component_TeamWork/$Tasks/default/icon/icon_chat.png)")
                                var dynamicItemText = new Element("div.dynamicItemText",{styles:this.css.dynamicItemText}).inject(dynamicItem);
    ...
    setTaskData:function(){
        ...
        */
        ...
        //来源
        if(this.taskSourceValue){ 
            this.loadSourceValue()
        }
        //任务说明
        ...
        //任务进展
        if(this.taskDetailContainer){
            this.loadDetailValue()
        }
        //重要程度
        if(this.taskImportantContainer){
            this.loadImportantValue()
        }
        //紧急程度
        if(this.taskUrgencyContainer){
            this.loadUrgencyValue()
        }
        //工作进度
    ...
    loadNameValue:function(){  //名称
        ...
        //debugger;
        if(this.control.isEdit && (this.taskData.workStatus != "completed" && this.taskData.workStatus != "canceled") && this.control.isFounder){ //权限修改
    ...
    loadStatusValue:function(){ //状态
        ...
        if(this.taskData.workStatus == "processing"){
            this.taskStatusValueContainer.setStyles({"color":"#666666"});
            this.taskStatusValueIcon.setStyles({"background-image":"url(../x_component_TeamWork/$Tasks/default/icon/icon_flow.png)"});
            this.taskStatusValueText.set("text",this.lp.status.processing);
        }else if(this.taskData.workStatus == "delay"){
            this.taskStatusValueContainer.setStyles({"color":"#d4237a"});
            this.taskStatusValueIcon.setStyles({"background-image":"url(../x_component_TeamWork/$Tasks/default/icon/icon_delay.png)"});
            this.taskStatusValueText.set("text",this.lp.status.delay);
        }else if(this.taskData.workStatus == "canceled"){
            this.taskStatusValueContainer.setStyles({"color":"#d81e06"});
            this.taskStatusValueIcon.setStyles({"background-image":"url(../x_component_TeamWork/$Tasks/default/icon/icon_cancle.png)"});
            this.taskStatusValueText.set("text",this.lp.status.canceled);
        }else if(this.taskData.workStatus == "completed"){
            this.taskStatusValueContainer.setStyles({"color":"#69b439"});
            this.taskStatusValueIcon.setStyles({"background-image":"url(../x_component_TeamWork/$Tasks/default/icon/icon_complete.png)"});
        ...
        if(this.control.isEdit){ //权限
            this.taskStatusValueContainer.addEvents({
                click:function(){
                    var sc = new MWF.xApplication.TeamWork.Tasks.StatusCheck(this.container, this.taskStatusValueContainer, this.app, {data:this.taskData}, {
                        css:this.css, lp:this.lp, axis : "y",
                        position : { //node 固定的位置
                            x : "right",
                            y : "middle"
                        ...
                        onClose:function(rd){
                            ...
                            if(rd.status){
                                if(rd.status != this.taskData.workStatus){ 
                                    ...
                                    // if(rd.status == "delay" || rd.status == "completed"){
                                    //     _self.app.confirm("warn",_self.taskStatusValue,"确认","所有下级任务状态都会变更为已完成？",300,120,function(){
                ...
                mouseover:function(){
                    ...
                    this.getElement(".taskStatusValueIcon").setStyles({ "background-image":"url(../x_component_TeamWork/$Tasks/default/icon/icon_down.png)"})
                },
                mouseout:function(){
                    this.setStyles(_self.css.taskStatusValueContainer);
                    var bgurl = "url(../x_component_TeamWork/$Tasks/default/icon/icon_draft.png)";
                    if(_self.taskData.workStatus == "processing")bgurl = "url(../x_component_TeamWork/$Tasks/default/icon/icon_flow.png)";
                    else if(_self.taskData.workStatus == "delay")bgurl = "url(../x_component_TeamWork/$Tasks/default/icon/icon_delay.png)";
                    else if(_self.taskData.workStatus == "canceled")bgurl = "url(../x_component_TeamWork/$Tasks/default/icon/icon_cancle.png)";
                    else if(_self.taskData.workStatus == "completed")bgurl = "url(../x_component_TeamWork/$Tasks/default/icon/icon_complete.png)";
    ...
    loadDutyValue:function(){
        ...
        if(this.control.isEdit && (this.taskData.workStatus != "completed" && this.taskData.workStatus != "canceled") && this.control.isFounder){ //权限
            if(this.taskData.executor==""){
                ...
                this.loadTaskPerson(this.taskDutyValueContainer,this.taskData.executor,this.control.isEdit);
            }
        }else{
            if(this.taskData.executor!=""){
    ...
    loadTimeValue:function(){
        ...
        if(this.taskData.startTime && this.taskData.startTime!=""){
            this.taskStartTime.set("text",this.taskData.startTime.split(" ")[0]);
        ...
        if(this.taskData.endTime && this.taskData.endTime!=""){
            this.taskEndTime.set("text",this.taskData.endTime.split(" ")[0]);
                ...
                click:function(){
                    ...
                    this.app.selectCalendar(this.taskStartTime,this.container,opt,function(json){
                        ...
                        if(json.action == "ok"){
                            ...
                            sd.mainValue = json.dateString+" 00:00:00"
                ...
                click:function(){
                    ...
                    this.app.selectCalendar(this.taskEndTime,this.container,opt,function(json){
                        ...
                        if(json.action == "ok"){
                            ...
                            sd.mainValue = json.dateString + " 23:59:59"
                        }else if(json.action == "clear"){
                            this.taskEndTime.set("text",this.lp.taskTimeEnd);
                            sd.mainValue = ""
                        }
    ...
    loadSourceValue:function(){  //来源
        var _self = this;
        this.taskSourceValue.set("text",this.taskData.source); 
        if(this.control.isEdit && (this.taskData.workStatus != "completed" && this.taskData.workStatus != "canceled") && this.control.isFounder){ //权限修改
            if(this.taskData.source == undefined || this.taskData.source == ""){ 
                this.taskSourceValue.set("text",this.lp.editTip);
            }
            var node = this.taskSourceValue;
            var nameEdit = false;
            var overStatus = null;
            node.addEvents({
                mouseenter:function(){
                    ...
                    var name = this.get("text");
                    node.empty();
                    var input = new Element("input.taskSourceInput",{type:"text",value:name,styles:_self.css.taskSourceInput}).inject(node);
                    input.addEvents({
                        click:function(ev){
                            var v = this.get("value").trim();
                            if(v == _self.lp.editTip){
                                this.set("value","")
                            }
                            nameEdit = true;
                            if(_self.app.st&&_self.app.st.node)_self.app.st.node.destroy();
                        ...
                        blur:function(){
                            ...
                            if(v != _self.taskData.source){
                                ...
                                _self.updateSingleProperty(sd,function(json){
                                    _self.taskSourceValue.empty();
                                    _self.taskSourceValue.set("text",v);
                                    _self.taskSourceValue.setStyles({"background-color":""});
                                    _self.taskData.source = v;
                                    nameEdit = false;
                                })
                            }
    ...
    loadRemarkValue:function(){
        ...
        _vlist.forEach(function(v){
            _html = _html + '<p style="margin-top:0px;">'+v+'</p>'
        })

        this.taskRemarkValue.set("html",_html);
        if(this.control.isEdit && (this.taskData.workStatus != "completed" && this.taskData.workStatus != "canceled") && this.control.isFounder){ //权限
            if(value =="") this.taskRemarkValue.set("html",this.lp.editTip);
            this.taskRemarkValue.removeEvent("click").addEvents({
                click:function(e){ 
                    this.taskRemarkValue.setStyles({"background-color":"#ffffff"});
                    this.taskRemarkValue.empty();
                    var remarkTextarea = new Element('textarea',{styles:this.css.taskRemarkTextarea,value:value}).inject(this.taskRemarkValue);
                    remarkTextarea.addEvents({
                        click:function(e){
                            e.stopPropagation()
                        }
                    });
                    var taskRemarkActionContainer = new Element("div.taskRemarkActionContainer",{styles:this.css.taskRemarkActionContainer}).inject(this.taskRemarkValue);
                    var taskRemarkActionOk = new Element("div.taskRemarkActionOk",{styles:this.css.taskRemarkActionOk,text:this.lp.save}).inject(taskRemarkActionContainer);
                    taskRemarkActionOk.addEvents({
                        click:function(){
                            var sd = {
                                taskId:this.taskData.id,
                                property:"description",
                                mainValue:remarkTextarea.get("value"),
                                secondaryValue:remarkTextarea.get("value")
                            };
                            this.updateSingleProperty(sd,function(){
                                this.taskData.description = remarkTextarea.get("value");
                                this.loadRemarkValue();
                            }.bind(this))
                        }.bind(this)
                    });
                    var taskRemarkActionCancel = new Element("div.taskRemarkActionCancel",{styles:this.css.taskRemarkActionCancel,text:this.lp.cancel}).inject(taskRemarkActionContainer);
                    taskRemarkActionCancel.addEvents({
                        mouseover:function(){this.setStyles({"color":"#4A90E2"})},
    ...
    loadDetailValue:function(){
        var value = this.taskData.detail || "";
        var _vlist = value.split('\n');
        var _html = ''
        _vlist.forEach(function(v){
            _html = _html + '<p style="margin-top:0px;">'+v+'</p>'
        ...
        this.taskDetailValue.set("html",_html);
        if(this.control.isEdit && (this.taskData.workStatus != "completed" && this.taskData.workStatus != "canceled")){ //权限
            if(value =="") this.taskDetailValue.set("html",this.lp.editTip);
            this.taskDetailValue.removeEvent("click").addEvents({
                click:function(e){
                    this.taskDetailValue.empty();
                    var detailTextarea = new Element('textarea',{styles:this.css.taskRemarkTextarea,value:value}).inject(this.taskDetailValue);
                    detailTextarea.addEvents({
                        click:function(e){
                            e.stopPropagation()
                        }
                    });
                    var taskDetailActionContainer = new Element("div.taskDetailActionContainer",{styles:this.css.taskRemarkActionContainer}).inject(this.taskDetailValue);
                    var taskDetailActionOk = new Element("div.taskRemarkActionOk",{styles:this.css.taskRemarkActionOk,text:this.lp.save}).inject(taskDetailActionContainer);
                    taskDetailActionOk.addEvents({
                        click:function(){
                            var sd = {
                                taskId:this.taskData.id,
                                property:"detail",
                                mainValue:detailTextarea.get("value"),
                                secondaryValue:detailTextarea.get("value")
                            };
                            this.updateSingleProperty(sd,function(){
                                this.taskData.detail = detailTextarea.get("value");
                                this.loadDetailValue();
                            }.bind(this))
                        }.bind(this)
                    });
                    var taskDetailActionCancel = new Element("div.taskDetailActionCancel",{styles:this.css.taskRemarkActionCancel,text:this.lp.cancel}).inject(taskDetailActionContainer);
                    taskDetailActionCancel.addEvents({
                        mouseover:function(){this.setStyles({"color":"#4A90E2"})},
                        mouseout:function(){this.setStyles({"color":"#999999"})},
                        click:function(e){
                            this.loadDetailValue();
                    ...
                    this.taskDetailValue.removeEvents("click")
    ...
    loadImportantValue:function(){
        if(this.taskImportantValue)this.taskImportantValue.empty();
        var node = new Element("div.taskImportantValueText",{styles:this.css.taskImportantValueText}).inject(this.taskImportantValue);
        if(!this.taskData.important)this.taskData.important = this.lp.importantStatus.high
        node.set("text",this.taskData.important);
        if(this.control.isEdit && (this.taskData.workStatus != "completed" && this.taskData.workStatus != "canceled")){
            node.addEvents({
                click:function(){
                    var pc = new MWF.xApplication.TeamWork.Tasks.ImportantCheck(this.container, node, this.app, {data:this.taskData}, {
                        css:this.css, lp:this.lp, axis : "y",
                        position : { //node 固定的位置
                            x : "right",
                            y : "middle"
                        ...
                        onClose:function(rd){ 
                            if(!rd) return;
                            if(rd.value){
                                if(rd.value != this.taskData.important){
                                    var sd = {
                                        taskId:this.taskData.id,
                                        property:"important",
                                        mainValue:rd.value,
                                    ...
                                    this.updateSingleProperty(sd,function(){
                                        this.taskData.important = rd.value;
                                        this.loadImportantValue();
                                    }.bind(this))
                                }
                            }
                ...
                mouseout:function(){
                    this.setStyles({"border":"1px solid #999999"})
                }
            })
        }
    },
    loadUrgencyValue:function(){
        if(this.taskUrgencyValue)this.taskUrgencyValue.empty();
        var node = new Element("div.taskUrgencyValueText",{styles:this.css.taskUrgencyValueText}).inject(this.taskUrgencyValue);
        if(!this.taskData.urgency)this.taskData.urgency = this.lp.urgencyStatus.high
        node.set("text",this.taskData.urgency);
        if(this.control.isEdit && (this.taskData.workStatus != "completed" && this.taskData.workStatus != "canceled")){
            node.addEvents({
                click:function(){
                    var pc = new MWF.xApplication.TeamWork.Tasks.UrgencyCheck(this.container, node, this.app, {data:this.taskData}, {
                        css:this.css, lp:this.lp, axis : "y",
                        position : { //node 固定的位置
                            x : "right",
                            y : "middle"
                        ...
                        onClose:function(rd){ 
                            if(!rd) return;
                            if(rd.value){
                                if(rd.value != this.taskData.urgency){
                                    var sd = {
                                        taskId:this.taskData.id,
                                        property:"urgency",
                                        mainValue:rd.value,
                                    ...
                                    this.updateSingleProperty(sd,function(){
                                        this.taskData.urgency = rd.value;
                                        this.loadUrgencyValue();
                                    }.bind(this))
                                }
                            }
    ...
    loadProgressValue:function(){
        if(this.taskProgressValue)this.taskProgressValue.empty();
        this.progressValueText = new Element("div.progressValueText",{styles:this.css.progressValueText}).inject(this.taskProgressValue);
        if(!this.taskData.progress) this.taskData.progress = 0
        
        this.progressLineContainer = new Element("div.progressLineContainer",{styles:this.css.progressLineContainer}).inject(this.taskProgressValue);
        this.progressBaseLine = new Element("div.progressBaseLine",{styles:this.css.progressBaseLine}).inject(this.progressLineContainer);
        this.progressPercentLine = new Element('div.progressPercentLine',{styles:this.css.progressPercentLine}).inject(this.progressBaseLine);
        
        //初始化值
        this.progressValueText.set("text",this.taskData.progress + "%");
        var totalWidth = this.progressBaseLine.getWidth() ;
        this.progressPercentLine.setStyles({
            "width":(totalWidth * this.taskData.progress / 100 )+"px"
        })
        ...
        if(this.control.isEdit && (this.taskData.workStatus != "completed" && this.taskData.workStatus != "canceled")){
            ...
            this.progressMove = new Element("div.progressMove",{styles:this.css.progressMove}).inject(this.progressLineContainer);
            this.progressMove.setStyles({
                "left":(totalWidth * this.taskData.progress / 100)+"px"   //10圆的半径
            });
            var drag = new Drag(this.progressMove, {
                "compensateScroll": true,

                "onStart": function(el, e){
                    this.progressDragMove(el,e);
                    drag.stop();
                }.bind(this)
            });
        }
    ...
    progressDragMove:function(el,e){
        var drag = new Drag.Move(el, {
            container: this.progressLineContainer,
            ...
            "onDrag": function(el,e){
                this.progressMove.setStyles({"top":"0px"});
                var _left = el.getPosition(this.progressLineContainer).x;
                //console.log(_left)
                this.progressPercentLine.setStyles({"width":(_left)+"px"});

                var totalWidth = this.progressBaseLine.getWidth();
                this._percent = Math.floor(((_left)/totalWidth) * 100 )
                this.progressValueText.set("text",this._percent+"%")
            }.bind(this),
            "onDrop": function(el, dr, e){
                var sd = {
                    taskId:this.taskData.id,
                    property:"progress",
                    mainValue:this._percent,
                    secondaryValue:""
                };
                this.updateSingleProperty(sd,function(){
                    this.taskData.progress = this._percent;
    ...
    loadPriorityValue:function(){
        ...
        if(this.control.isEdit){
            node.addEvents({
                click:function(){
                    var pc = new MWF.xApplication.TeamWork.Tasks.PriorityCheck(this.container, node, this.app, {data:this.taskData}, {
                        css:this.css, lp:this.lp, axis : "y",
                        position : { //node 固定的位置
                            x : "right",
                            y : "middle"
    ...
    loadTagValue:function(){
        ...
        this.taskTagAdd.addEvents({
            mouseover:function(){this.setStyles({"background-image":"url(../x_component_TeamWork/$Tasks/default/icon/icon_subtask_add.png)"})},
            mouseout:function(){this.setStyles({"background-image":"url(../x_component_TeamWork/$Tasks/default/icon/icon_jia.png)"})},
            click:function(){
        ...
        if(this.control.isEdit && (this.taskData.workStatus != "completed" && this.taskData.workStatus != "canceled")){ //权限
            ...
            this.subTaskNewContent.addEvents({
                click:function(){
                    ...
                    this.subTaskEndTime = new Element("div.subTaskEndTime",{styles:this.css.subTaskEndTime,text:this.lp.taskSubEndTimePlaceholder}).inject(this.subTaskNewValue);
                    this.subTaskNewPerson = new Element("div.subTaskNewPerson",{styles:this.css.subTaskNewPerson}).inject(this.subTaskNewValue);

                    this.subTaskEndTime.addEvents({
                        click:function(){
                            var opt = {
                                type:"date"
                            };
                            this.app.selectCalendar(this.subTaskEndTime,this.container,opt,function(json){
                                if(json.action == "ok"){
                                    this.subTaskEndTime.set("text",json.dateString);
                                    this.taskSubNewEndTime = json.dateString+" 23:59:59"
                                }else if(json.action == "clear"){
                                    this.subTaskEndTime.set("text",this.lp.taskSubEndTimePlaceholder);
                                    this.taskSubNewEndTime = ""
                                }
                            }.bind(this))
                        }.bind(this)
                    ...
                    this.subTaskNewOK.addEvents({
                        click:function(){
                            ...
                            var data = {
                                ...
                                important:this.lp.importantStatus.high,
                                urgency:this.lp.importantStatus.high,
                                endTime:this.taskSubNewEndTime||""
                            };
    ...
    loadSubTaskItem:function(node,data){
        ...
        var subTaskItemEndTime = new Element("div.subTaskItemEndTime",{styles:this.css.subTaskItemEndTime,text:endTimestr}).inject(subTaskItemContainer);
    ...
    loadSubTaskPerson:function(node,identity,flag){
        ...
        var closeStyles={
            ...
            "background":"url(../x_component_TeamWork/$Tasks/default/icon/icon_off.png) no-repeat center"
        };
...
MWF.xApplication.TeamWork.Tasks.TaskMore = new Class({
    ...
    _loadCustom : function( callback ){
        ...
        copyTaskIcon.setStyles({"background":"url(../x_component_TeamWork/$Tasks/default/icon/taskcopy.png) no-repeat center"});
        ...
        moveTaskIcon.setStyles({"background":"url(../x_component_TeamWork/$Tasks/default/icon/taskmove.png) no-repeat center"});
        ...
        // favTaskIcon.setStyles({"background":"url(../x_component_TeamWork/$Tasks/default/icon/taskfav.png) no-repeat center"});
        ...
        subTaskIcon.setStyles({"background":"url(../x_component_TeamWork/$Tasks/default/icon/tasksub.png) no-repeat center"});
        ...
        if(this.data.data.control && this.data.data.control.delete){
            ...
            removeTaskIcon.setStyles({"background":"url(../x_component_TeamWork/$Tasks/default/icon/taskremove.png) no-repeat center"});
...
MWF.xApplication.TeamWork.Tasks.StatusCheck = new Class({
    Extends: MWF.xApplication.TeamWork.Common.ToolTips,
    options : {
        // displayDelay : 300,
        hasArrow:false,
    ...
    _loadCustom : function( callback ){
        ...
        //已搁置
        var delayContainer = new Element("div",{styles:container}).inject(this.contentNode);
        var flowText = new Element("div",{styles:text,text:this.lp.status.delay}).inject(delayContainer);
        flowText.setStyles({"background-color":"#eab9d1","color":"#ffffff"});
        if(this.data.data.workStatus == "delay"){
            var flowIcon = new Element("div",{styles:icon}).inject(delayContainer);
        }

        delayContainer.addEvents({
            click:function(){
                var data = {"status":"delay"};
                this.close(data)
            }.bind(this),
            mouseover:function(){this.setStyles({"background-color":"#f2f5f7"})},
            mouseout:function(){this.setStyles({"background-color":""})}
        ...
        //已取消
        var canceledContainer = new Element("div",{styles:container}).inject(this.contentNode);
        var flowText = new Element("div",{styles:text,text:this.lp.status.canceled}).inject(canceledContainer);
        flowText.setStyles({"background-color":"#ea5974","color":"#ffffff"});
        if(this.data.data.workStatus == "canceled"){
            var flowIcon = new Element("div",{styles:icon}).inject(canceledContainer);
        }

        canceledContainer.addEvents({
            click:function(){
...
MWF.xApplication.TeamWork.Tasks.ImportantCheck = new Class({
    Extends: MWF.xApplication.TeamWork.Common.ToolTips,
    options : {
        // displayDelay : 300,
        hasArrow:false,
    ...
    _loadCustom : function( callback ){
        ...
        var _data = this.lp.importantStatus; 
        var _arr = [];
        for(key in _data){
            _arr.push(_data[key])
        }
        _arr.forEach(function(item){
            ...
            if(this.data.data.important == item){
...
MWF.xApplication.TeamWork.Tasks.UrgencyCheck = new Class({
    Extends: MWF.xApplication.TeamWork.Common.ToolTips,
    options : {
        // displayDelay : 300,
        hasArrow:false,
    ...
    _loadCustom : function( callback ){
        ...
        if(!this.data.data.urgency) return;

        var _data = this.lp.urgencyStatus; 
        var _arr = [];
        for(key in _data){
            _arr.push(_data[key])
        }
        _arr.forEach(function(item){
            ...
            if(this.data.data.urgency == item){
                new Element("div",{styles:icon}).inject(vContainer);
            }
            vContainer.addEvents({
                click:function(){
...
MWF.xApplication.TeamWork.Tasks.PriorityCheck = new Class({
    Extends: MWF.xApplication.TeamWork.Common.ToolTips,
    options : {
        // displayDelay : 300,
        hasArrow:false,
...
MWF.xApplication.TeamWork.Tasks.DynamicType = new Class({
    Extends: MWF.xApplication.TeamWork.Common.ToolTips,
    options : {
        // displayDelay : 300,
        hasArrow:false,
