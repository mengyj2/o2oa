    ...
    var t = {
        Binary: {
            fixdata: function(e) {
                for (var r = "",
                t = 0,
                n = 10240; t < e.byteLength / n; ++t) r += String.fromCharCode.apply(null, new Uint8Array(e.slice(t * n, t * n + n)));
        ...
        format2WB: function(e, r, t, n) {
            ...
            t.SheetNames.push(r),
            t.Sheets[r] = Object.assign({},
            e, {
                "!ref": n || o[0] + ":" + o[o.length - 1]
            }),
            t
        },
