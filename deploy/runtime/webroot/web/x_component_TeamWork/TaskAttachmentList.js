...
MWF.xApplication.TeamWork.TaskAttachmentList = new Class({
    ...
    load: function () {
        ...
        this.rootActions.TaskAction.get(this.data.id,function(json){
            ...
            if(this.taskData.control && this.taskData.control.edit  && (this.taskData.workStatus != "completed" && this.taskData.workStatus != "canceled")){  //权限
...
MWF.xApplication.TeamWork.TaskAttachmentList.More = new Class({
    ...
    _loadCustom : function( callback ){
        ...
        if(this.explorer.taskData.control && this.explorer.taskData.control.edit  && (this.explorer.taskData.workStatus != "completed" && this.explorer.taskData.workStatus != "canceled")){  //权限
